      ...
      <div className="relative w-full max-w-md z-10">
        ...
        <div className="text-center mb-8 animate-fade-in-down">
          <Link href="/" className="inline-flex items-center justify-center space-x-3 mb-4 group">
            <div className="w-16 h-16 bg-gradient-to-br from-teal-500 via-blue-500 to-violet-600 rounded-2xl flex items-center justify-center shadow-2xl transform transition-all duration-300 group-hover:scale-110 group-hover:rotate-3">
            ...
            <span className="font-display font-bold text-4xl">
              ...
              <span className="bg-gradient-to-r from-blue-600 to-violet-600 bg-clip-text text-transparent">Medic</span>
            </span>
          </Link>
          <p className="text-gray-600 text-sm mt-2">Your Health, Our Priority</p>
        </div>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  spellCheck="false"
                />
                <p className="text-xs text-gray-500">Email addresses are not case-sensitive</p>
              </div>
              <div className="space-y-2">
